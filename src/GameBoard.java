...
public class GameBoard extends JComponent {
	...
	protected void paintComponent(Graphics arg0) {
		...
		// Score label
		Program.highScore.setText("<html>Highscore:<br>" + Integer.toString(Game.highScore) + "</html>");
		Program.latestRuns.setText("<html>Latest run:<br>" + Integer.toString(Game.score) + "</html>");
		game.draw(graphics);
	}
